<?php require_once '../controller/authControllers.php'; ?>
<!DOCTYPE html>
<html>
              ...
              <div class="alert">
                ...
                <div class="form-group">
                  <div class="text-center">
                    <button type="submit" name="signup-btn" class="btn btn-primary mt-4">Create account</button>
                  </div> 
                </div>
